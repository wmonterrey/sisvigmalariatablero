...
<body>
        			...
        			<!-- Content -->
         			<div class="container-fluid flex-grow-1 container-p-y">
         				...
         				<h4 class="d-flex justify-content-between align-items-center py-2 mb-4">
			              <div class="font-weight-bold"><strong><c:out value="${user.completeName}" /></strong></div>
            			...
            			<div class="row no-gutters row-bordered container-m-nx">
            				<!-- Counters -->
				           <div class="col-sm-6 col-md-4 col-lg-6 col-xl-4" id="visitsdiv">
				           ...
				           <div class="col-sm-6 col-md-4 col-lg-6 col-xl-4" id="averagediv">
				             <div class="d-flex align-items-center container-p-x py-4">
            			...
            			<div class="row">
            				...
            				<div class="col-md-12 col-lg-6 col-xl-6">
            					<div class="card mb-4" id="accesosdiv">
            						<h6 class="card-header with-elements">
						            	<div class="card-header-title">Accesos de usuario</div>
						            </h6>
						            <div class="datatablediv">
						              	<table id="accesestable" class="table table-striped table-bordered">
						              		<thead>
						                    <tr>
						                      <th>Fecha ingreso</th>
						                      <th>Tiempo promedio (mins)</th>
						                    </tr>
						                  </thead>
						                  <tbody>
										  </tbody>
    ...
    <spring:url value="/resources/vendor/libs/bootstrap-daterangepicker/bdrp_{language}.js" var="bdrpLang">
  	...
  	<spring:url value="/resources/js/views/actividadusuario.js" var="Actividad" />
  	<script src="${Actividad}" type="text/javascript"></script>
  	
  	<spring:url value="/resources/help/home.html" var="userActivityUrl"/>
  	
  	<!-- Urls -->
  	<c:set var="usuario" value="${user.username}"/>
  	<spring:url value="/admin/users/pagesvisiteduser/" var="visitadasUrl"/>
  	<spring:url value="/admin/users/activitybydayuser/" var="porDiaUrl"/>
  	<spring:url value="/admin/users/accessesuser/" var="accesosUrl"/>
  	

	<script>
		jQuery(document).ready(function() {
			
			var parametros = {visitadasUrl: "${visitadasUrl}",porDiaUrl: "${porDiaUrl}",accesosUrl: "${accesosUrl}",lenguaje: "${lenguaje}",dataTablesLang: "${dataTablesLang}",usuario:"${usuario}"};
