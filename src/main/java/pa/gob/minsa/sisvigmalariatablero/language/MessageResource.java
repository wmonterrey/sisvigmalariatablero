package pa.gob.minsa.sisvigmalariatablero.language;
 ...
 */
@Entity
@Table(name = "messages", catalog = "sisvig_tablero", uniqueConstraints={@UniqueConstraint(columnNames = {"catRoot" , "catKey"})})
